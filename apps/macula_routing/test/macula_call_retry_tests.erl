%% EUnit tests for macula_call_retry.
-module(macula_call_retry_tests).
...
first_attempt_success_terminates_immediately_test() ->
    ...
    Result = macula_call_retry:execute(#{
