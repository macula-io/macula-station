...
%%
%% The pure Tier B codec (`macula_bootstrap_mdns') and the Tier B
%% orchestrator (`macula_bootstrap_tier_b') are transport-agnostic.
%% This behaviour abstracts the "send a query and collect responses"
%% step so:
%% <ul>
%%   <li>Production uses `macula_bootstrap_mdns_udp' (real IPv6
...
-module(macula_bootstrap_mdns_transport).
