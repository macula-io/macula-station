...
-module(macula_station_identity_config_tests).
-include_lib("eunit/include/eunit.hrl").

-define(MOD, macula_station_identity_config).
...
shared_listener_opts_app_env_test_() ->
    {setup,
     fun() ->
         clear_listener_env(),
         application:set_env(macula_station, port,     1234),
         application:set_env(macula_station, certfile, "/tmp/cert.pem"),
         application:set_env(macula_station, keyfile,  "/tmp/key.pem")
     end,
...
shared_listener_opts_app_env_wins_over_env_var_test_() ->
    {setup,
     fun() ->
         clear_listener_env(),
         application:set_env(macula_station, port, 1111),
